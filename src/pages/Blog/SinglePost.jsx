...
const SinglePost = () => {
    ...
    return (
        ...
        >
            <div className="pt-28 h-full px-4 md:px-10 lg:px-20">
                <div className="max-w-4xl mx-auto p-6 bg-black/90 border border-bronze shadow-md">
                    ...
                    <div className="p-4 font-sairaCondensed">
                        ...
                        <div className="text-white/75 px-3 py-3 flex flex-col md:flex-row text-xs gap-7">
                        ...
                        <div className="text-lg  py-5 text-customGrey mb-6" dangerouslySetInnerHTML={{ __html: blog.content }} />
                    </div>
                </div>
            </div>
        </section>
