    ...
    return (
        <section className="bg-black/20 h-screen max-h-[720px] grid items-center">
            <div className="w-full max-w-screen-xl px-5 md:px-20 z-10 text-center md:text-right mx-auto justify-center pt-44 md:pt-0">
                ...
                <div>
                    <p className="text-customGrey font-sairaCondensed tracking-wider font-medium md:text-xl  pt-5 md:pt-1 pb-32 md:pb-10">Push your limits, redefine your strength, and transform your body.<br />
                ...
                <div className="inline-flex flex-col items-center">
                    ...
                    <BronzeBtn to="/about" text="Explore more"/>
